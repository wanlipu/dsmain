"""
Backprop NN training on Wine data (Feature selection complete)
...
OUTFILE = 'part1-1_backprop\\BACKPROP_NORM_LOG.txt'
...
def main():
    """Run this experiment"""
    training_ints = initialize_instances('wine_train_norm.txt')
    testing_ints = initialize_instances('wine_test_norm.txt')
